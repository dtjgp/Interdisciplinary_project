...
def PlotPie_retailor(iteration_time, contract_market_share):
    images = []
    ...
    images[0].save('animated_pie_charts_retailor.gif', save_all=True, append_images=images[1:], duration=500, loop=0)  