...
def Contractid_usertype_pie_retailor(iteration_time, contractid_usertype_share):
    images = []
    ...
    images[0].save('contractid_customertype_share_retailor.gif', save_all=True, append_images=images[1:], duration=500, loop=0)
