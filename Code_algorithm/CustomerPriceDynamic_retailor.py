...
def CustomerPriceDynamic_retailor(contract_price):
    ...
    contract1_price.to_csv('contract1_price_iter_retailor.csv')
    contract2_price.to_csv('contract2_price_iter_retailor.csv')
    contract3_price.to_csv('contract3_price_iter_retailor.csv')
    contract4_price.to_csv('contract4_price_iter_retailor.csv')
    contract5_price.to_csv('contract5_price_iter_retailor.csv')
    
    # folder_name = 'contract_price_iter_retailor'
    # if not os.path.exists(folder_name):
    #     os.makedirs(folder_name)
        
    # file_list = ['contract1_price_iter_retailor.csv', 'contract2_price_iter_retailor.csv', 'contract3_price_iter_retailor.csv',
    #              'contract4_price_iter_retailor.csv', 'contract5_price_iter_retailor.csv']
    # for i in file_list:
