...
def FindOptimalContract_retailor(selfid,self_contract, neighbor_contract):
    ...
    # 打开合同参数pickle文件
    with open('contract_price_retailor.pickle', 'rb') as f:
...
if __name__ == '__main__':
    a, b = FindOptimalContract_retailor(10,1,3)
    print(a)
    print(b)
